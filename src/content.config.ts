...
const industries = defineCollection({
  ...
  schema: z.object({
    ...
    order: z.number().default(0),
    hidden: z.boolean().default(false),
    sidebar: z.array(z.object({ label: z.string(), value: z.string() })).optional(),
    entityEyebrow: z.string().optional(),
    entityHeadline: z.string().optional(),
    ...
    problemEyebrow: z.string().optional(),
    problemHeadline: z.string().optional(),
    problemIntro: z.string().optional(),
    oldWayLabel: z.string().optional(),
    oldWay: z.array(z.string()).optional(),
    newWay: z.array(z.string()).optional(),
    delEyebrow: z.string().optional(),
    delHeadline: z.string().optional(),
    deliverables: z.array(z.object({
      icon: z.string(),
      title: z.string(),
      desc: z.string(),
    ...
    whoIntro: z.string().optional(),
    whoTriggers: z.array(z.string()).optional(),
    whoCta: z.object({ headline: z.string(), body: z.string() }).optional(),
