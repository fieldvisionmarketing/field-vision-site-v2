---
title: "What Is ABCT®? Field Vision's Four-Phase Marketing Growth System"
description: "ABCT® is Field Vision's end-to-end client engagement framework: four phases that take your marketing from raw inputs to a fully trained, self-sustaining growth system. Here's how it works."
...
**Setting the Strategic Foundation**: the positioning, audience definition, competitive differentiation, and core messaging that everything downstream will ladder back to. We use our [SCORE® framework](/guides/score-framework) to structure this work.
...
[Book a discovery call with Field Vision to learn more about an ABCT® engagement.](/contact)
